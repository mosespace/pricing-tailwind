    ...
    <section className='py-2 px-[2rem]'>
      <div id='#buttons' className='bg-slate-900 py-4 rounded-3xl'>
        <div className='px-4 gap-6 flex flex-wrap'>
          ...
          <button
            onClick={() => handleBtnClick("startup")}
            className={`${
              btnClicked === "startup"
                ? "bg-blue-800 px-8 py-2 rounded-3xl"
                : ""
          ...
          <button
            onClick={() => handleBtnClick("e-commerce")}
            className={`${
              btnClicked === "e-commerce"
                ? "bg-blue-800 px-8 py-2 rounded-3xl"
                : ""
            }`}
          >
